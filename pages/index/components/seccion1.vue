<template>
  <v-container>
    <!-- Línea separadora antes de Características Principales -->
    <v-divider></v-divider>

    <!-- Características Principales -->
    <v-row justify-center class="section">
    ...
    <v-container class="section text-center d-flex flex-column align-center justify-center">
